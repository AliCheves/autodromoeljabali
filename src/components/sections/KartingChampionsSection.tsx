...
export function KartingChampionsSection({ image }: KartingChampionsSectionProps) {
  return (
    <section className="bg-brand-gray-dark py-20 lg:py-28 overflow-hidden">
      <div className="container-xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left">
          ...
          <h2 className="font-black text-4xl md:text-5xl text-white mb-2">
            DONDE COMIENZAN LOS <span className="text-brand-red">CAMPEONES</span>
          </h2>
          <p className="text-brand-gray-light text-base md:text-lg leading-relaxed mb-8 mt-4 break-words">
          ...
          <ul className="space-y-6 mb-10">
            <li className="flex items-start gap-4">
              ...
              <div>
                <span className="font-black text-white text-lg">Pista Profesional</span>
                <div className="text-brand-gray-light text-sm mt-1">Circuito certificado por la FIA con sistemas de cronometraje de última generación</div>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <span className="mt-1">
              ...
              <div>
                <span className="font-black text-white text-lg">Seguridad Primero</span>
                <div className="text-brand-gray-light text-sm mt-1">Protocolos de seguridad avanzados y estándares de equipamiento de primer nivel</div>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <span className="mt-1">
              ...
              <div>
                <span className="font-black text-white text-lg">Entrenamiento Élite</span>
                <div className="text-brand-gray-light text-sm mt-1">Programas dirigidos por instructores profesionales de automovilismo con experiencia</div>
              </div>
            </li>
          </ul>
          <Link
            href="/eventos/eventoskarting"
            className="btn-cta mt-2 w-full sm:w-auto"
          >
