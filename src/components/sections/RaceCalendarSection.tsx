    ...
    <section className="bg-white py-20" style={{ fontFamily: "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      <div className="container-xl">
        ...
        <div className="mt-16 flex justify-center">
          <Link href="/calendario" className="flex items-center justify-center gap-3 px-8 py-3 bg-black text-white font-bold text-base sm:text-lg rounded-none shadow-none border border-black hover:bg-white hover:text-black transition-all w-full sm:w-auto text-center" style={{ fontFamily: "inherit" }}>
